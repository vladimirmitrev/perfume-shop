        ...
        return httpSecurity.authorizeHttpRequests(
                ...
                authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/products/all",
                                ...
                                "/brand-products/**",
                                "/search").permitAll()
                        .requestMatchers("/products/add", "/products/edit/**","/orders-all", "/cancel-order", "/cancel-customer-order").hasAnyRole(UserRoleEnum.ADMIN.name(), UserRoleEnum.EMPLOYEE.name())
